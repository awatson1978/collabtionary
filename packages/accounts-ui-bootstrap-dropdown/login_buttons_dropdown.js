...
Template._loginButtonsLoggedOutDropdown.showLoginMenu = function(){
    return Session.get('show_login_menu');
    //return false;
};
Template._loginButtonsLoggedInDropdown.showLoginMenuLoggedIn = function(){
    return Session.get('show_login_menu');
};
...
Session.setDefault('show_login_menu', false);
Template._loginButtonsLoggedInDropdown.events({
  ...
  'click #login-buttons-profile': function(){
    ...
    Meteor.flush();
      if(Session.get('show_login_menu')){
          Session.set('show_login_menu', false);
      }

      //alert(Session.get('show_login_menu'));
    //toggleDropdown();
  }
});
